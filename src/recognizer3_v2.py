...
class voice_recognitor3():
    ...
    def __init__(self):
        ...
        self.asr_sub = rospy.Subscriber("recognize_voice3", Float32, self.callback)
...
if __name__=='__main__':
    ...
    """
    try:
        rospy.init_node('asr_node3')       # Init ROS node

        asr_object = voice_recognitor3()
